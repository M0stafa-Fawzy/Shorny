...
function replayConsultation() {
    replyRouter.post('/consultations/:id/replies', auth, async (req, res) => {
...
function updateReply() {
    replyRouter.patch('/replies/:id', auth, async (req, res) => {
...
function deleteReply() {
    replyRouter.delete('/replies/:id', auth, async (req, res) => {
        try {
            if (req.actor.role === 'lawyer') {
                const rep = await replies.findOne({ _id: req.params.id, lawyer: req.actor._id })
                if (!rep) {
